...
describe('ChallengeController', () => {
  ...
  describe('createChallenge()', () => {
    it('should create a challenge and return result', async () => {
      mockChallengeService.createChallenge.mockResolvedValue(mockChallengeResult);
  ...
  describe('listChallenges()', () => {
    it('should list all challenges without filters', async () => {
      mockChallengeService.listChallenges.mockResolvedValue([mockChallengeResult]);
  ...
  describe('resolveChallenge()', () => {
    ...
    it('should resolve with UPHELD status', async () => {
      ...
      const upheldResult = { ...mockChallengeResult, status: ChallengeStatus.UPHELD };
      mockChallengeService.resolveChallenge.mockResolvedValue(upheldResult);

      const result = await controller.resolveChallenge('user-1', 'challenge-1', upheldDto);
